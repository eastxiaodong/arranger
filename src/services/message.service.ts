...
export class MessageService {
  ...
  // 获取所有消息
  getAllMessages(filters?: { session_id?: string; message_type?: string; agent_id?: string }): BlackboardEntry[] {
  ...
  private resolveCategory(message: SendMessageInput): BlackboardEntry['category'] {
    ...
    if (message.message_type === 'system' || agentId === 'workflow_orchestrator') {
      return 'system_event';
    }
